<div class="d-flex align-items-center justify-content-between">
    <a href="/dashboard" class="logo d-flex align-items-center">
      <img src="{{('/admin/assets/img/logo3.png')}}" alt="">
      <span class="d-none d-lg-block">Sipab</span>
    </a>
    <i class="bi bi-list toggle-sidebar-btn"></i>
  </div><!-- End Logo -->

  <div class="search-bar">
    <form class="search-form d-flex align-items-center" method="GET" action="{{ request()->is('program*') ? route('program') : route('rencaran') }}">
        @csrf
